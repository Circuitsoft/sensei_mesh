...
// <q> NRF_BLE_QWR_ENABLED  - nrf_ble_qwr - Queued writes support module
...
// <q> PERIPHERAL_RESOURCE_SHARING_ENABLED  - nrf_drv_common - Peripheral
// drivers common module
...
// structures can be buffered at any time.
...
// <i> one page to be used by the system for garbage collection. The total
// amount
...
// <o> FDS_VIRTUAL_PAGE_SIZE  - The size of a virtual page of flash memory,
...
// <i> operation will be queued at once without waiting for the previous
// operations
// <i> to complete. In general, increase the queue size if you frequently
// receive
// <i> @ref FS_ERR_QUEUE_FULL errors when calling @ref fs_store or @ref
// fs_erase.
...
// <o> FS_OP_MAX_RETRIES - Number attempts to execute an operation if the
// SoftDevice fails.
// <i> Increase this value if events return the @ref FS_ERR_OPERATION_TIMEOUT
// <i> error often. The SoftDevice may fail to schedule flash access due to high
// BLE activity.
...
// <o> FS_MAX_WRITE_SIZE_WORDS - Maximum number of words to be written to flash
// in a single operation.
// <i> Tweaking this value can increase the chances of the SoftDevice being
// <i> able to fit flash operations in between radio activity. This value is
// bound by the
// <i> maximum number of words which the SoftDevice can write to flash in a
// single call to
// <i> @ref sd_flash_write, which is 256 words for nRF51 ICs and 1024 words for
// nRF52 ICs.
...
// as 'small' block.
// <i>  Size of each memory blocks identified as 'small' block. Memory block are
...
// as 'medium' block.
// <i>  Size of each memory blocks identified as 'medium' block. Memory block
// are recommended to be word-sized.
...
// as 'large' block.
// <i>  Size of each memory blocks identified as 'large' block. Memory block are
// recommended to be word-sized.
...
// <o> NRF_CSENSE_PAD_HYSTERESIS - Minimal value of change to decide that pad
// was touched.
#ifndef NRF_CSENSE_PAD_HYSTERESIS
#define NRF_CSENSE_PAD_HYSTERESIS 15
#endif

// <o> NRF_CSENSE_PAD_DEVIATION - Minimal value measured on pad to take its
// value while calculating step.
#ifndef NRF_CSENSE_PAD_DEVIATION
#define NRF_CSENSE_PAD_DEVIATION 70
#endif

// <o> NRF_CSENSE_MIN_PAD_VALUE - Minimum normalized value on pad to take its
// value into account.
...
// <o> TIMER0_FOR_CSENSE - First TIMER instance used by the driver (except
// nRF51)
#ifndef TIMER0_FOR_CSENSE
#define TIMER0_FOR_CSENSE 1
#endif

// <o> TIMER1_FOR_CSENSE - Second TIMER instance used by the driver (except
// nRF51)
...
// <i> Time of single measurement can be calculated as T =
// (1/2)*MEASUREMENT_PERIOD*(1/f_OSC) where f_OSC = I_SOURCE / (2C*(VUP-VDOWN)
// ). I_SOURCE, VUP and VDOWN are values used to initialize COMP and C is
// capacitance of used pad.
...
//==========================================================
// <o> NRF_LOG_BACKEND_MAX_STRING_LENGTH - Buffer for storing single output
// string
...
// <i> If higher resolution timestamp source is used it might be needed to
// increase that
